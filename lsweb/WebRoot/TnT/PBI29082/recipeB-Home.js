    $(function () {
        if (!$('body').data('PBI29082')) {
            ...
            //$('.homefeatures.hide-for-small-only').find('div:eq(0)').find('.hideie8').attr('src', '/Content/tnt/29082/credithistory.png');
            //$('.homefeatures.hide-for-small-only').find('div:eq(0)').find('.showie8').attr('src', '/Content/tnt/29082/credithistory.svg');
            ...
            //$('.homefeatures.hide-for-small-only').find('div:eq(1)').find('.hideie8').attr('src', '/Content/tnt/29082/assets.png');
            //$('.homefeatures.hide-for-small-only').find('div:eq(1)').find('.showie8').attr('src', '/Content/tnt/29082/assets.svg');
            ...
            //$('.homefeatures.hide-for-small-only').find('div:eq(2)').find('.hideie8').attr('src', '/Content/tnt/29082/incomehistory.png');
            //$('.homefeatures.hide-for-small-only').find('div:eq(2)').find('.showie8').attr('src', '/Content/tnt/29082/incomehistory.svg');
            ...
            //$('.homefeatures.hide-for-small-only').find('div:eq(3)').find('.hideie8').attr('src', '/Content/tnt/29082/income.png');
            //$('.homefeatures.hide-for-small-only').find('div:eq(3)').find('.showie8').attr('src', '/Content/tnt/29082/income.svg');

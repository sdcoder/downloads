...
var FOUNDATION_VERSION = '6.4.3-lightstream';
...
var Reveal = function (_Plugin) {
  ...
  _createClass(Reveal, [{
    ...
    value: function open() {
      ...
      this.$activeAnchor = __WEBPACK_IMPORTED_MODULE_0_jquery___default()(document.activeElement); //.is(this.$anchor) ? $(document.activeElement) : this.$anchor;

(function () {
    ...
    angular.module('LightStreamApp')
        .controller('RateDataController', ['$scope', '$http', function ($scope, $http) {
            var self = this;
            $scope.autoMinRate = 0;
            $scope.autoMaxRate = 0;
            var autoPurposes = [
            ...
            self.rateService = function (purpose) {
                $http.post('/services/rates', { 'PurposeOfLoan': purpose.purpose }).then(function (response) {
...
//# sourceMappingURL=RateDataController.js.map
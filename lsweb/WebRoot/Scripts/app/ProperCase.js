...
var ProperCase = (function () {
    ...
    function split(s, del) {
        var arrS = [], i = 0, j = 0, k = 0, delim = String(del);
    ...
    function _pCase(STRING) {
        var UcaseNext = false, SkipNext = false, iCounter, iChar, strReturn_Value = "", iTemp = STRING.length;
        if (iTemp === 0) {
            return "";
        }
    ...
    function _properCase(string) {
        var i, j, thisWord, skip, tokens = [], ret = "", 
...
//# sourceMappingURL=ProperCase.js.map
...
(function () {
    ...
    var securityInformationController = function ($scope, $location, $sce, preferences) {
        ...
        $scope.getAccountSyncInfo = function () {
            ...
            preferences.getAccountSyncData(accountSyncRequestData).then(function (data) {
                var count1 = Number(0);
                var count2 = Number(0);
        ...
        $scope.SetDefaultValues = function (element, index) {
        ...
        $scope.saveAccountSyncAndMove = function (form, userId, model) {
            ...
            preferences.syncAndMoveAccount(syncAndMoveData).then(function (data) {
                if (data.Success) {
                    $scope.Model.alert = { type: "success", message: "Your account has been moved to user ID " + $scope.Model.SecurityInformation.UserName + "." };
                    form.$setPristine();
                    $scope.Model.SecurityInformation = {};
        ...
        $scope.handleRadioClick = function (field, account, optionSelected) {
            switch (field) {
                case "emailAddress":
...
//# sourceMappingURL=securityInformationController.js.map